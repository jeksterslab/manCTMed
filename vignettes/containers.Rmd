...
```bash
apptainer pull docker://ijapesigan/manctmed:latest
```

> **NOTE**: For complete reproducibility of the software stack, the actual `manctmed.sif` used in the simulations can be requested from the maintainer of this GitHub repository.
