...
empirical_effects_1 <- root$find_file(
  ".setup",
  "data-raw",
  "empirical-effects-phy-aff-cog.Rds"
)
empirical_delta_1 <- root$find_file(
  ".setup",
  "data-raw",
  "empirical-delta-phy-aff-cog.Rds"
)
empirical_mc_1 <- root$find_file(
  ".setup",
  "data-raw",
  "empirical-mc-phy-aff-cog.Rds"
)
empirical_effects_2 <- root$find_file(
  ".setup",
  "data-raw",
  "empirical-effects-cog-aff-phy.Rds"
)
empirical_delta_2 <- root$find_file(
  ".setup",
  "data-raw",
  "empirical-delta-cog-aff-phy.Rds"
)
empirical_mc_2 <- root$find_file(
  ".setup",
  "data-raw",
...
```{r}
#| echo = FALSE
plot(readRDS(empirical_effects_1))
```
...
```{r}
#| echo = FALSE
plot(readRDS(empirical_delta_1))
```
...
```{r}
#| echo = FALSE
plot(readRDS(empirical_effects_2))
```
...
```{r}
#| echo = FALSE
plot(readRDS(empirical_delta_2))
```
