...
#SBATCH --output=/scratch/ibp5092/manCTMed/.sim/sim-03-grundy.out
#SBATCH --error=/scratch/ibp5092/manCTMed/.sim/sim-03-grundy.err
...
PARALLEL_TMP_FOLDER=$(mktemp -d -q "/scratch/ibp5092/manCTMed/.sim/tmp/$TODAY-sim-03-grundy-XXXXXXXX")
