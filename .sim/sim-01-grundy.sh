...
#SBATCH --output=/scratch/ibp5092/manCTMed/.sim/sim-01-grundy.out
#SBATCH --error=/scratch/ibp5092/manCTMed/.sim/sim-01-grundy.err
...
PARALLEL_TMP_FOLDER=$(mktemp -d -q "/scratch/ibp5092/manCTMed/.sim/tmp/$TODAY-sim-01-grundy-XXXXXXXX")
