...
#SBATCH --output=sim-compress.out
#SBATCH --error=sim-compress.err
...
PARALLEL_TMP_FOLDER=$(mktemp -d -q "/scratch/$USER/${PROJECT}/.sim/tmp/$TODAY-sim-compress-XXXXXXXX")
