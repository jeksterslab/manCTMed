...
#SBATCH --output=/scratch/ibp5092/manCTMed/.sim/sim-04.out
#SBATCH --error=/scratch/ibp5092/manCTMed/.sim/sim-04.err
...
PARALLEL_TMP_FOLDER=$(mktemp -d -q "/scratch/ibp5092/manCTMed/.sim/tmp/$TODAY-sim-04-XXXXXXXX")
