...
This vignette accompanies Illustration 2. The goal of the illustration
is to calculate confidence intervals for the direct, indirect, and total
...
features the `DeltaMed`, `MCMed`, `BootMed`, `DeltaMedStd`, `MCMedStd`,
and `BootMedStd` functions from the `cTMed` package.
...
intervals for the direct, indirect, and total effects for a time
interval of one, two, and three are given below.
