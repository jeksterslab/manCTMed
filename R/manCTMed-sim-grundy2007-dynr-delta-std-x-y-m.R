#' Simulation Replication - Grundy2007DynrDeltaStdXYM
#'
...
SimGrundy2007DynrDeltaStdXYM <- function(taskid,
                                         repid,
                                         output_folder,
                                         seed,
                                         suffix,
  ...
  fn_output <- SimFN(
    output_type = "grundy2007-dynr-delta-std-xym",
    output_folder = output_folder,
    suffix = suffix
  )
  run <- .SimCheck(
